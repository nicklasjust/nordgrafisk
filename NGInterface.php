...
<div class="container">
	...
	<div class="panel-group accepted" id="accordion" role="tablist" aria-multiselectable="true">
		...
		<div class="panel panel-default">
	  		...
	  		<div class="panel-heading" role="tab" id="acceptedHeadingOne">

	  			<h4 class="panel-title">

			        <a data-toggle="collapse" data-parent="#accordion" href="#acceptedOne" aria-expanded="true" aria-controls="acceptedOne">
	    	...
	    	<div id="acceptedOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="acceptedHeadingOne">
	...
	<div class="panel-group declined" id="accordion" role="tablist" aria-multiselectable="true">
		...
		<div class="panel panel-default">
	  		...
	  		<div class="panel-heading" role="tab" id="declinedHeadingOne">

	  			<h4 class="panel-title">

			        <a data-toggle="collapse" data-parent="#accordion" href="#declinedOne" aria-expanded="true" aria-controls="declinedOne">
			          Collapsible Group Item #1
			        </a>
	    	...
	    	<div id="declinedOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="declinedHeadingOne">
